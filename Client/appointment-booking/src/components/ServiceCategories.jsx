...
const services = [
  ...
  const serviceOwners = [
    ...
    },
    {
      ...
      description: 'Modern dental practice with latest technology'
    },
    {
      id: 3,
      ...
      specialties: ['Personal Training', 'Nutrition Coaching', 'Group Classes'],
      description: 'Certified trainers helping you achieve your fitness goals'
    }
  ];
          ...
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-low transition-colors  ${
                  activeTab === 'serviceOwners' ? ' text-purple-700' : 'text-gray-700 hover:bg-gray-100'
                }`}
              >
                Service Owners
              </button>
