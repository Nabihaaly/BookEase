        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSoloProvider = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceOwners", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ServiceOwners_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceOwners_ServiceCategories_CategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServiceOwnerID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ServiceOwners_ServiceOwnerID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOwners_CategoryID",
                table: "ServiceOwners",
                column: "CategoryID");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceOwners_UserID",
                table: "ServiceOwners",
                column: "UserID",
                unique: true);
